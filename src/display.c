...
static enum render_method render_method = RENDER_FILL_TRIANGLE;
...
bool initialize_window(void) {
	...
	window_width = fullscreen_width / 1.5f;
	window_height = fullscreen_height / 1.5f;
...
bool should_render_wireframe_vertex(void)
{
