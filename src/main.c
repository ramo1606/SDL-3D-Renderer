...
void setup(void) {
    ...
    load_mesh("../assets/obj/f22.obj", "../assets/textures/f22.png", vec3_new(1, 1, 1), vec3_new(-3, 0,10), vec3_new(0, 0, 0));
    load_mesh("../assets/obj/efa.obj", "../assets/textures/efa.png", vec3_new(1, 1, 1), vec3_new(+3, 0, 10), vec3_new(0, 0, 0));
}
